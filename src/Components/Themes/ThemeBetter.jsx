        ...
        "C9-12": [
            {
                ...
                "description": "Security is a concern for everyone. Security systems that are not invasive and which protect both your physical belongings and your digital footprint are a requirement. Devising systems that manage the security of your belongings and your safety would be a much-needed innovation in this sphere."
            },
            {
                "name": "Alternative Sources of Energy",
                "image": "./assets/themes/alternativesrc.jpg",
                "description": "Women's Safety is an often discussed problem. To tackle this issue, one must think of solutions that are non-obtrusive, cannot be used against the victim, ensure timely intervention and act as a deterrent to prevent future such actions. If it is an app-based solution, the data collected must also be kept secure so that it cannot be used for nefarious purposes. An ideal solution would tackle all these pitfalls and give an out-of-the-box idea that can be made accessible quickly."
            },
            {
                "name": "Space & Astronomy",
                "image": "./assets/themes/space.jpg",
                "description": "Smart Education goes beyond the notion of E-Learning. Smart Education doesn't just mean including courses about technology, it also means giving a framework to quickly and efficiently update the learning materials, methodology, tools, etc. It would also provide ideas to cover the Digital Divide and prevent it from widening further. One must ponder on how to bring all the necessary life skills imparted in a traditional classroom to a future, 'SMART' classroom"
            },
            {
                "name": "Waste Management",
                "image": "./assets/themes/wastemng.jpg",
                "description": "Smart Education goes beyond the notion of E-Learning. Smart Education doesn't just mean including courses about technology, it also means giving a framework to quickly and efficiently update the learning materials, methodology, tools, etc. It would also provide ideas to cover the Digital Divide and prevent it from widening further. One must ponder on how to bring all the necessary life skills imparted in a traditional classroom to a future, 'SMART' classroom"
            },
        ]
